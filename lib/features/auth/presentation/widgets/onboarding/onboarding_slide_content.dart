...
import 'package:delivery_app/features/auth/presentation/widgets/onboarding/onboarding_illustration.dart';
...
class OnboardingSlideContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: NoktaSpacing.lg),
      child: Column(
